...
#define SWIGTYPE_p_GEN swig_types[1]
...
SWIGINTERN PyObject *_wrap_Sample(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  resultobj = SWIG_NewPointerObj((new GEN(static_cast< const GEN& >(result))), SWIGTYPE_p_GEN, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
}
...
static swig_type_info _swigt__p_GEN = {"_p_GEN", "GEN *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_GEN[] = {  {&_swigt__p_GEN, 0, 0, 0},{0, 0, 0, 0}};
